...
export function AccountShell({
  ...
  subtitle: string;
  children: ReactNode;
  /** "narrow" = formulários de conta; "full" = usa toda a largura máxima do sistema. */
  width?: "narrow" | "full";
}) {
  ...
  return (
    <PanelLayout accent={accent} menu={menu}>
      <div className={`mx-auto w-full ${width === "full" ? "max-w-full" : "max-w-[min(42rem,var(--app-max-w))]"} space-y-[clamp(1.5rem,4vw,2rem)]`}>
