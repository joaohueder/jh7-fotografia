-- =====================================================================
-- JH7 Gestão Fotográfica — USUÁRIOS: quem está logado agora
-- Rode no Supabase AUTOHOSPEDADO depois de 23_usuarios_realtime.sql.
-- Acrescenta as colunas "logado" (tem sessão ativa) e "sessao_em"
-- (última atividade da sessão) na listagem do painel SA.
-- =====================================================================
